...
import 'package:latihantngl6/Model/Model_Login.dart';
import 'package:latihantngl6/screen_page/page_bottom_navigation.dart';
import 'package:latihantngl6/screen_page/page_profil_user.dart';
  ...
  Future<ModelLogin?> registerAccount() async {
    try {
      ...
      http.Response response = await http.post(
        Uri.parse('http://192.168.18.8/edukasi_server/login.php'),
        body: {
